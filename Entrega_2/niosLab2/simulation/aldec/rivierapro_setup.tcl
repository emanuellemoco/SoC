...
alias file_copy {
  ...
  file copy -force $QSYS_SIMDIR/submodules/niosLab2_onchip_memory_dados.hex ./
...
ensure_lib                                              ./libraries/onchip_memory_dados                         
vmap       onchip_memory_dados                          ./libraries/onchip_memory_dados                         
...
alias com {
  ...
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/niosLab2_onchip_memory_dados.vhd"                                -work onchip_memory_dados                         
