...
# Memory: onchip_memory_dados
MEM_1 := niosLab2_onchip_memory_dados
$(MEM_1)_NAME := onchip_memory_dados
...
$(MEM_1)_END := 0x0001f3ff
$(MEM_1)_SPAN := 0x0001f400
$(MEM_1)_HIERARCHICAL_PATH := onchip_memory_dados
$(MEM_1)_WIDTH := 32
$(MEM_1)_HEX_DATA_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: onchip_memory_dados
onchip_memory_dados: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
